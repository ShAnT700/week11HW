...
test.describe("Search - Listing Page", () => {
  ...
  test("Should search by keyword", async ({ authenticatedPage}, testInfo) => {
    ...
    await authenticatedPage.goto(`${baseUrl}featured-listings`);
    await listingsPage.lightModeSwitch.check();
    await listingsPage.searchInput.fill(sharedListing.title);
    await listingsPage.searchButton.click();
  ...
  test("Should search by bedrooms", async ({ authenticatedPage }, testInfo) => {
    ...
    await authenticatedPage.goto(`${baseUrl}featured-listings`);
    await listingsPage.lightModeSwitch.check();
    await listingsPage.bedroomsCount.click();
    await listingsPage.badRoomsDropMenu.click();
    await listingsPage.searchButton.click();
  ...
  test("Should search by city", async ({ authenticatedPage}, testInfo) => {
    ...
    await authenticatedPage.goto(`${baseUrl}featured-listings`);
    await listingsPage.lightModeSwitch.check();
    await listingsPage.cityInput.fill(sharedListing.city);
    await listingsPage.searchButton.click();
  ...
  test("Should search by price", async ({ authenticatedPage }, testInfo) => {
    ...
    await authenticatedPage.goto(`${baseUrl}featured-listings`);
    await listingsPage.lightModeSwitch.check();
    await listingsPage.lowerPriceInput.fill(minPrice);
    await listingsPage.higherPriceInput.fill(maxPrice);
    await listingsPage.searchButton.click();
    await listingsPage.firstMoreInfoButton.click();
